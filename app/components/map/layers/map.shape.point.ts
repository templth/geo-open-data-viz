...
export class ShapePointLayerComponent extends AbstractLayer {
  @Input()
  ...
  getStylesBackgroundFill(obj: any) {
    return getPropertyValue(obj,
      ['styles', 'background', 'fill'],
      SHAPE_POINT_DEFAULTS.BACKGROUND_FILL);
  }
  ...
  getStylesLinesStroke(obj: any) {
    return getPropertyValue(obj,
      ['styles', 'lines', 'stroke'],
      SHAPE_POINT_DEFAULTS.LINES_STROKE);
  }
  ...
  getStylesLinesStrokeWidth(obj: any) {
    return getPropertyValue(obj,
      ['styles', 'lines', 'strokeWidth'],
      SHAPE_POINT_DEFAULTS.LINES_STROKE_WIDTH);
  }
