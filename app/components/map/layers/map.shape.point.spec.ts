...
import {SHAPE_POINT_DEFAULTS} from './layers.defaults';
import {ShapePointLayer} from '../../../model/map.model';
...
describe('Tests for shape point layer', () => {
  var defaultShapeLayerConfig = <ShapePointLayer>{
    id: 'shapeLayer',
    type: 'shape',
    display: {
      shape: {
  ...
  var shapeLayerConfig = <ShapePointLayer>{
    id: 'shapeLayer',
    type: 'shape',
    display: {
      shape: {
  ...
  it('should define default values for properties',
    async(inject([TestComponentBuilder], (tcb: TestComponentBuilder) => {
      ...
      tcb.overrideProviders(ShapePointLayerComponent, [
        provide(MapUpdateService, { useValue: updateService })
      ])
        .createAsync(ShapePointLayerComponent).then((componentFixture) => {
          ...
          checkShapeStructure(nativeElement, SHAPE_POINT_DEFAULTS.BACKGROUND_FILL,
            SHAPE_POINT_DEFAULTS.BACKGROUND_OPACITY,
            SHAPE_POINT_DEFAULTS.LINES_STROKE, SHAPE_POINT_DEFAULTS.LINES_STROKE_WIDTH,
            SHAPE_POINT_DEFAULTS.LINES_STROKE_OPACITY);
        });
    })));
  ...
  // TODO: test point resizing feature
  // TODO: test point emanating feature
});