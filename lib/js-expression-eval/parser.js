...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\
	...
	return Parser;*/
	console.log()
    if (typeof define === "function" && define.amd) this.Parser = Parser, define(Parser); else if (typeof module === "object" && module.exports) module.exports = Parser; else this.Parser = Parser;
}();
